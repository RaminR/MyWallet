package ru.ya.rrmstu.mywallet.core;

import ru.ya.rrmstu.mywallet.core.dao.impls.OperationDAOImpl;
import ru.ya.rrmstu.mywallet.core.dao.impls.SourceDAOImpl;
import ru.ya.rrmstu.mywallet.core.dao.impls.StorageDAOImpl;
import ru.ya.rrmstu.mywallet.core.decorator.OperationSync;
import ru.ya.rrmstu.mywallet.core.decorator.SourceSync;
import ru.ya.rrmstu.mywallet.core.decorator.StorageSync;
...
////            testConvert();
//
//            ((IncomeOperation)operationSync.get(38)).setFromAmount(new BigDecimal(100));
//            ((IncomeOperation)operationSync.get(38)).setFromCurrency(Currency.getInstance("RUB"));
//            ((IncomeOperation)operationSync.get(38)).setToStorage(storageSync.get(10));
//            operationSync.update(operationSync.get(38));
//
